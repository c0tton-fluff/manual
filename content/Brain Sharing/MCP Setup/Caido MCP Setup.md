...
MCP server and CLI for the Caido web proxy. Browse, replay, and analyze HTTP traffic from AI assistants or your terminal. Built on the community [Go SDK](Caido%20SDK%20Go.md) with OAuth + PAT auth, HTTPQL filtering, session cookie jars, batch operations, and 42 tools + 4 read-only resources.
